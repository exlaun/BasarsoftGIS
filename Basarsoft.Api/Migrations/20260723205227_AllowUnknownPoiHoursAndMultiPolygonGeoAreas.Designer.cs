...
namespace Basarsoft.Api.Migrations
{
    ...
    [Migration("20260723205227_AllowUnknownPoiHoursAndMultiPolygonGeoAreas")]
    partial class AllowUnknownPoiHoursAndMultiPolygonGeoAreas
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.HasSequence<int>("seq_tbl_route");

            modelBuilder.HasSequence<int>("seq_tbl_stop");
            ...
            modelBuilder.Entity("Basarsoft.Api.Models.Stop", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id")
                        .HasDefaultValueSql("nextval('seq_tbl_stop')")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
                    ...
                    b.HasIndex("ModifiedUserId")
                        .HasDatabaseName("ix_tbl_stop_modified_user_id");

                    b.HasIndex("RouteId")
                        .HasDatabaseName("ix_tbl_stop_route_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_tbl_stop_user_id");

                    b.HasIndex("RouteId", "SequenceOrder")
                        .HasDatabaseName("ix_tbl_stop_route_id_sequence_order");

                    b.ToTable("tbl_stop", (string)null);
                });

            modelBuilder.Entity("Basarsoft.Api.Models.TransportRoute", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                        .HasColumnName("id")
                        .HasDefaultValueSql("nextval('seq_tbl_route')")
                        .HasAnnotation("Npgsql:ValueGenerationStrategy", NpgsqlValueGenerationStrategy.None);
                    ...
                    b.Property<bool>("IsGeometryStale")
                        .HasColumnType("boolean")
                        .HasColumnName("is_geometry_stale");
                    ...
                    b.Property<string>("RoutingErrorCode")
                        .HasMaxLength(40)
                        .HasColumnType("character varying(40)")
                        .HasColumnName("routing_error_code");
                    ...
                    b.HasKey("Id")
                        .HasName("pk_tbl_route");

                    b.HasIndex("ModifiedUserId")
                        .HasDatabaseName("ix_tbl_route_modified_user_id");

                    b.HasIndex("UserId")
                        .HasDatabaseName("ix_tbl_route_user_id");

                    b.ToTable("tbl_route", (string)null);
                });
            ...
            modelBuilder.Entity("Basarsoft.Api.Models.Stop", b =>
                {
                    b.HasOne("Basarsoft.Api.Models.User", null)
                        .WithMany()
                        .HasForeignKey("ModifiedUserId")
                        .HasConstraintName("fk_tbl_stop_users_modified_user_id");

                    b.HasOne("Basarsoft.Api.Models.TransportRoute", null)
                        .WithMany()
                        .HasForeignKey("RouteId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired()
                        .HasConstraintName("fk_tbl_stop_tbl_route_route_id");
                    ...
                    b.HasOne("Basarsoft.Api.Models.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tbl_stop_users_user_id");
                });
            ...
            modelBuilder.Entity("Basarsoft.Api.Models.TransportRoute", b =>
                {
                    b.HasOne("Basarsoft.Api.Models.User", null)
                        .WithMany()
                        .HasForeignKey("ModifiedUserId")
                        .HasConstraintName("fk_tbl_route_users_modified_user_id");
                    ...
                    b.HasOne("Basarsoft.Api.Models.User", null)
                        ...
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("fk_tbl_route_users_user_id");
                });
